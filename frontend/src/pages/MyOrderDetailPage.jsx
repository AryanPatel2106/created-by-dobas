...
const MyOrderDetailPage = () => {
  ...
  return (
    <div className="py-12 max-w-4xl mx-auto">
      <Link to="/my-orders" className="flex items-center gap-2 text-gray-500 hover:text-[var(--theme-pink)] mb-8 transition-colors">
          <ArrowLeft size={20} />
          Back to My Orders
      </Link>
      <h1 className="font-playfair text-3xl font-bold text-gray-800 mb-6">Details for Order #{order._id}</h1>
